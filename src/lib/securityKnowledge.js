...
const SECURITY_REFERENCE = [
  ...
  },
  {
    label: 'ACE KRX금현물',
    code: '411060',
    companyName: 'ACE KRX금현물',
    aliases: ['ace krx physical gold', 'ace krx gold spot', '금현물', '골드', '금'],
    region: '한국',
    sector: '금',
    style: '방어형',
    risk: '중위험',
  ...
  },
  {
    label: 'KODEX 골드선물(H)',
    code: '132030',
    companyName: 'KODEX 골드선물(H)',
    aliases: ['kodex gold futures', '골드선물', '금선물', '골드', '금'],
    region: '한국',
    sector: '금',
    style: '방어형',
    risk: '중위험',
  ...
  },
  {
    label: 'TIGER 금은선물(H)',
    code: '139320',
    companyName: 'TIGER 금은선물(H)',
    aliases: ['tiger gold silver futures', '금은선물', '골드', '실버', '금'],
    region: '한국',
    sector: '금',
    style: '방어형',
    risk: '중위험',
  ...
  },
  {
    label: 'GLDM',
    code: 'GLDM',
    companyName: 'SPDR Gold MiniShares Trust',
    aliases: ['spdr gold minishares', 'gold mini', '미니 금', 'gold'],
    region: '글로벌',
    sector: '금',
    style: '방어형',
    risk: '중위험',
