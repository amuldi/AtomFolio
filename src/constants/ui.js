...
export const UI_TEXT = {
  ko: {
    ...
    desktopConnectRevealHint:
      '이 코드는 다시 표시되지 않습니다. 지금 복사해 메뉴바 앱에 붙여넣으세요.',
    ...
    authDeleteAccountHint:
      '계정과 저장된 포트폴리오 데이터 삭제를 요청할 수 있습니다. 요청 확인 후 처리됩니다.',
    ...
    legalDisclaimer:
      '이 서비스가 보여주는 수익률·점수·시뮬레이션은 입력한 데이터를 기계적으로 계산한 결과이며, 투자 자문이나 매매 추천이 아닙니다.',
    legalTermsLink: '이용약관',
    legalPrivacyLink: '개인정보처리방침',
  ...
  en: {
    ...
    desktopConnectRevealHint:
      "This code won't be shown again — copy it now and paste it into the menu bar app.",
    ...
    authDeleteAccountHint:
      'Request deletion of your account and stored portfolio data. Handled after we confirm the request.',
    ...
    legalDisclaimer:
      'The returns, scores, and simulations shown here are calculated mechanically from data you entered — not investment advice or a trade recommendation.',
